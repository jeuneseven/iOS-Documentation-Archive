...
* 关于线程编程：介绍了线程相关的概念以及它在应用设计当中扮演的角色
* 线程管理：提供了OS X当中线程相关的技术信息以及你该如何使用它们
* 运行循环：介绍了如何在次级线程中管理事件处理循环的相关信息
* 同步：描述了同步性相关的问题以及你用来防止多线程中的数据污染或者导致你的程序崩溃所使用的工具
* 线程安全概览：提供了OS X以及iOS上的线程安全的总览以及一些关键的类库

## 另请参阅
对于线程的替代品的相关信息，参见“并发编程指南”。
本文档仅覆盖了了POSIX线程API的很少部分。更多关于POSIX线程使用的相关信息，参见pthread操作说明。对于更深入的POSIX线程的使用介绍，参见POSIX线程编程指南（David R. Butenhof著）。
# 关于线程编程
