...
| 类  | 描述  |
|:------------- |:---------------:|
|    NSInvocationOperation   | 关于如何使用该类的信息，参见“创建NSInvocationOperation对象”。 |
|    NSBlockOperation   |        关于如何使用该类的相关信息，参见“创建NSBlockOperation对象”。在OSX v10.6及以后的版本支持该类。更多关于blocks的信息，参见“blocks编程主题” |
|    NSOperation   |        关于如何定义自定义的操作对象，参见“定义一个自定义的操作对象”。 |
